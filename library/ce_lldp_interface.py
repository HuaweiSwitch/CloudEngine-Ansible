...
def main():
    ...
    argument_spec = dict(
        ...
        lldpadminstatus=dict(required=False,
                             choices=['txOnly', 'rxOnly', 'txAndRx', 'disabled'],
                             type='str'),
        manaddrtxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        portdesctxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        syscaptxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        sysdesctxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        sysnametxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        portvlantxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        protovlantxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        txprotocolvlanid=dict(required=False, type='int'),
        vlannametxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        txvlannameid=dict(required=False, type='int'),
        txinterval=dict(required=False, type='int'),
        protoidtxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        macphytxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        linkaggretxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        maxframetxenable=dict(required=False, choices=['true', 'false', ''], default=''),
        eee=dict(required=False, choices=['true', 'false', ''], default=''),
        dcbx=dict(required=False, choices=['true', 'false', ''], default=''),
