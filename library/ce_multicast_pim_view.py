...
options:
    ...
    src_name:
        description:
            - acl name (range 1-32) or basic acl number (range 2000-2999)
            - or advance number (range 2000-3999).
        required: false
        default: null
    interval:
        description:
...
def main():
    ...
    argument_spec = dict(
        ...
        frag=dict(required=False, choices=['true', 'false'],
                  type='str', default='false'),
        bid=dict(required=False, choices=['true', 'false'],
                 type='str', default='false'),
        bid_enable=dict(required=False, choices=['true', 'false'],
                        type='str', default='false'),
        trigcache=dict(required=False, choices=['true', 'false'],
                       type='str', default='false'),
        pre=dict(required=False, choices=['true', 'false'],
                 type='str', default='false'),
        addr=dict(required=False, type='str'),
        local_addr=dict(required=False, type='str'),
