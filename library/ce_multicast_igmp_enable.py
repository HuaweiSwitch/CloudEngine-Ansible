...
class IgmpSnoop(object):
    ...
    def __init__(self, argument_spec):
        ...
        self.igmp = self.module.params['igmp']
        self.version = self.module.params['version']
        if self.version is None:
            self.version = 2
        self.proxy = self.module.params['proxy']
        # state
        self.changed = False
...
def main():
    ...
    argument_spec = dict(
        ...
        igmp=dict(choices=['false', 'true'], required=False,
                  type='str', default='false'),
        version=dict(required=False, type='int', default=2),
        proxy=dict(choices=['false', 'true'], required=False,
                   type='str', default='false'),
